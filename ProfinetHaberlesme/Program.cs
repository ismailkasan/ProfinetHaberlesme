...
static void ReadMultipleVars(Plc plc)
{
...
static void ReadClasses(Plc plc)
{
    Console.WriteLine("\n--- DB 1 ---\n");
...
static void ReadSingleVariables(Plc plc)
{
    Console.WriteLine("\n--- DB 1 ---\n");
...
static void WriteSingleVariable(Plc plc)
{
    Console.WriteLine("\n--- DB 1 ---\n");
...
static void WriteBytes(Plc plc)
{
    Console.WriteLine("\n--- DB 1 ---\n");
...
static void ClearDbValues(Plc plc)
{
    byte[] db1Bytes = new byte[18];
    byte[] db3Bytes = new byte[18];
